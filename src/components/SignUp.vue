<template>
    <div class="signup_container">
        ...
        <div class="birth_box">
            <input v-model="identityNumber" placeholder="주민등록번호 앞 6자리" class="input" maxlength="6"  width="30%"> 
...
export default {
    ...
    methods: {
        ...
        allFieldsFilled() {
            // 모든 필드가 채워져 있는지 검사
            return this.userId && this.password && this.nickname && this.name && this.identityNumber && this.gender && this.phoneNumber;
        },
        async submitSignup() {
            const formData = {
                userId: this.userId,
